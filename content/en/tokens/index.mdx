...
Kernel's position is premised on [economic code running consensus](/learn/module-4/consensus/#funded-code-running-consensus). It's radical: forget quorum, participation, and all the other “nice” social outcomes people are trying to design for with ill-conceived tools that disassemble a potentially prosocial aspect of blockchains by allowing you to vote without spending your tokens. If you insist on programming your token to be an asset given the psychological pull this exerts over most people, then this is our advice:
